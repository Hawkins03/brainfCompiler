...
COMMON_SRCS = interp.c parser.c utils.c test.c semantics.c exp.c stmt.c reader.c
...
DEPS = interp.h parser.h utils.h test.h semantics.h exp.h stmt.h structs.h reader.h
